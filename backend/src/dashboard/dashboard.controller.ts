...
export class DashboardController {
  ...
  getOverview(@Query('year') year?: string) {
    return this.dashboardService.getOverview(year);
  }

  @Get('activity-timeline')
  @ApiOperation({ summary: 'Recent activity across all patients' })
  @ApiOkResponse({ description: 'Array of timeline events' })
  getActivityTimeline(@Query('year') year?: string) {
    return this.dashboardService.getActivityTimeline(year);
  }

  @Get('high-risk-babies')
  @ApiOperation({ summary: 'Recent high risk babies' })
  @ApiOkResponse({ description: 'Array of high risk babies' })
  getHighRiskBabies(@Query('year') year?: string) {
    return this.dashboardService.getHighRiskBabies(year);
  }

  @Get('upcoming-follow-ups')
  @ApiOperation({ summary: 'Upcoming scheduled follow-ups' })
  @ApiOkResponse({ description: 'Array of follow-ups' })
  getUpcomingFollowUps(@Query('year') year?: string) {
    return this.dashboardService.getUpcomingFollowUps(year);
  }
  ...
  getNotifications(@Query('year') year?: string) {
    return this.dashboardService.getNotifications(year);
  }
  ...
  getAnalytics(@Query('year') year?: string) {
    return this.dashboardService.getAnalytics(year);
  }
