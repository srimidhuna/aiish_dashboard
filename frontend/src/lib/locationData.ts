// Auto-generated comprehensive list of Indian States, Districts, and Taluks (Divisions)
export const locationData: Record<string, Record<string, string[]>> = {
  "ANDAMAN AND NICOBAR ISLANDS": {
    "NICOBARS": [
      "A - N Islands Division"
    ],
  ...
  "NA": {
    "NA": [
      ...
      "Ernakulam Division",
      "Faridabad Division",
      "Gautam Buddha Nagar Division office",
      "Gaya Division",
      "Goa Division",
      "Gorakhpur Division",
      "Gudivada Division",
      ...
      "Gwalior Division",
      "Hazaribagh Division",
      "Hooghly North Division",
      "Hooghly South Division",
      "Hyderabad City Division",
      "Hyderabad GPO Division",
      ...
      "Kanpur Moffusil Division",
      "Karnal Division",
      "Karur Division",
      "Kasaragod Division",
      "Khammam Division",
      "Kodagu Division",
      "Lucknow GPO Division",
      "Malegaon Division",
      "Mangaluru Division",
      "Manipur Division",
      "Medak Division",
  ...
  "PUNJAB": {
    ...
    "LUDHIANA": [
      "Ludhiana City Division",
      "Ludhiana Moffusil Division"
    ],
    "MALERKOTLA": [
      "Sangrur Division"
    ],
  ...
  "WEST BENGAL": {
    "24 PARAGANAS NORTH": [
      ...
      "Barasat Division",
      "Baruipur Division",
      "Kolkata East Division",
      "Kolkata North Division"
    ],
    "24 PARAGANAS SOUTH": [
      "Barasat Division",
      "Baruipur Division"
